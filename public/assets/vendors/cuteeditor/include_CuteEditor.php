...
//********************************************************
  ...
  function GetString()
  {
    ...
    else
    {
      ...
      $s=$s."<table ".$t." id=\"".$this->ClientID()."\" _IsCuteEditor=\"True\" cellspacing=\"0\" cellpadding=\"0\" style=\"background-color:".$this->BackColor.";border-color:".$this->BorderColor.";border-width:".$this->BorderWidth."px;border-style:".$this->BorderStyle.";table-layout:auto;height:".$this->Height."px;width:100%;\">";
