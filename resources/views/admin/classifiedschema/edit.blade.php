...
{{-- Web site Title --}}
@section('title')
@lang('classifiedschema/title.edit')
@parent
@stop
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('classifiedschema/title.edit')</li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
				...
				<div class="panel-body">
                    {!! Form::model($classifiedschema, array('url' => URL::to('admin/classifiedschema') . '/' . $classifiedschema->id.'/edit', 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
                    <div class="form-group {{ $errors->first('title', 'has-error') }}">
                        <label for="title" class="col-sm-2 control-label">
                            @lang('classifiedschema/form.title')
                        </label>
                        <div class="col-sm-5">
                            {!! Form::text('title', null, array('class' => 'form-control', 'placeholder'=>trans('classifiedschema/form.categoryname'))) !!}
                        </div>
                        <div class="col-sm-4">
					...
					<div class="tier-prices">
						...
						<div class="tier-wrapper">
							...
							<div class="tier-items">
								@forelse($classifiedschema->tierPrices as $key => $tier)
									<div class="form-group tier-item">
										<div class="col-md-2"></div>
										<div class="col-md-2">
											<label class="control-label">
