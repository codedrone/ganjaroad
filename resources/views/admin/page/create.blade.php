...
{{-- Page title --}}
@section('title')
    @lang('page/title.add-page') :: @parent
@stop
...
<section class="content-header">
    <!--section starts-->
    <h1>@lang('page/title.add-page')</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">@lang('page/title.add-page')</li>
    </ol>
</section>
<!--section ends-->
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            ...
            {!! Form::open(array('url' => URL::to('admin/page/create'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
                 <div class="row">
                    <div class="col-sm-8">
