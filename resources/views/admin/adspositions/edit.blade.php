...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>@lang('adspositions/title.adspositions')</li>
        <li class="active">@lang('adspositions/title.edit')</li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    {!! Form::model($adspositions, array('url' => URL::to('admin/adspositions') . '/' . $adspositions->id.'/edit', 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
                    <div class="form-group {{ $errors->first('title', 'has-error') }}">
						<label for="title" class="col-sm-2 control-label">
							@lang('adspositions/form.name')
						</label>
						<div class="col-sm-5">
							{!! Form::text('title', null, array('class' => 'form-control', 'placeholder'=>trans('adspositions/form.name'))) !!}
						</div>
						<div class="col-sm-4">
					...
					<input type="hidden" id="id" name="id" class="form-control" value="{!! $adspositions->id !!}" />
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
