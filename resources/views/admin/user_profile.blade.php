                                    ...
                                    <div class="text-center">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                <img src="{{ asset('assets/images/authors/avatar3.jpg') }}" data-src="holder.js/366x218/#fff:#000" class="img-responsive" width="366px" height="218px" />
                                            </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="col-md-3 col-xs-6">
                                                <div class="mag img-responsive">
                                                    <br />
                                                    <img data-toggle="magnify" class="thumbnail img-responsive" src="{{ asset('assets/images/authors/avatar.jpg') }}" alt=""></div>
                                            </div>
                                            <div class="col-md-3 col-xs-6">
                                                <div class="mag img-responsive">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('assets/images/authors/avatar3.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                            </div>
                                            <div class="col-md-3 col-xs-6">
                                                <div class="mag img-responsive">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('assets/images/authors/avatar7.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                            </div>
                                            <div class="col-md-3 col-xs-6">
                                                <div class="mag img-responsive">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('assets/images/authors/avatar5.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-xs-6">
                                                <div class="mag img-responsive">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('assets/images/authors/avatar4.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                            </div>
                                            <div class="col-md-3 col-xs-6">
                                                <div class="mag img-responsive">
                                                    <br />
                                            ...
                                            <div class="col-md-3 col-xs-6">
                                                <div class="mag img-responsive">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('assets/images/authors/avatar2.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                            </div>
                                            <div class="col-md-3 col-xs-6">
                                                <div class="mag img-responsive">
                                                    <br />
                                                    <img data-toggle="magnify" src="{{ asset('assets/images/authors/avatar.jpg') }}" alt="" class="thumbnail img-responsive"></div>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-xs-6">
                                                <div class="mag img-responsive">
                                                    <br />
                                                    <img data-toggle="magnify" class="thumbnail img-responsive" src="{{ asset('assets/images/authors/avatar1.jpg') }}" alt=""></div>
                                            </div>
                                            <div class="col-md-3 col-xs-6">
                                                <div class="mag img-responsive">
                                                    <br />
                                        ...
                                        <div class="activity">
                                            <div class="imgs-profile">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="{{ asset('assets/images/authors/avatar.jpg') }}" alt=""></a>
                                            ...
                                            <div class="imgs-profile">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="{{ asset('assets/images/authors/avatar1.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                                    ...
                                                    <div class="media blog-media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object thumbnail" src="{{ asset('assets/images/authors/avatar2.jpg') }}" alt=""></a>
                                            ...
                                            <div class="imgs-profile">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object" src="{{ asset('assets/images/authors/avatar3.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                            ...
                                            <div class="imgs-profile">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="{{ asset('assets/images/authors/avatar4.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                                    ...
                                                    <ul class="uploadphoto-list">
                                                        <li>
                                                            <a href="{{ asset('assets/images/authors/avatar2.jpg') }}" data-rel="prettyPhoto">
                                                                <img src="{{ asset('assets/images/authors/avatar2.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ asset('assets/images/authors/avatar3.jpg') }}" data-rel="prettyPhoto">
                                                                <img src="{{ asset('assets/images/authors/avatar3.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ asset('assets/images/authors/avatar.jpg') }}" data-rel="prettyPhoto">
                                                                <img src="{{ asset('assets/images/authors/avatar.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="imgs-profile">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="{{ asset('assets/images/authors/avatar7.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                            ...
                                            <div class="imgs-profile">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="{{ asset('assets/images/authors/avatar2.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                                    <strong>Lenny</strong>
                                                    posted a new note.
                                                    <br>
                                            ...
                                            <div class="imgs-profile">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle" src="{{ asset('assets/images/authors/avatar3.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                                    ...
                                                    <div class="media blog-media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object thumbnail" src="{{ asset('assets/images/authors/avatar4.jpg') }}" alt=""></a>
                                                        <div class="media-body col-md-8 col-lg-8 col-sm-8 col-xs-12">
                                                            <h4 class="media-title">
                                                                <a href="">
                                            ...
                                            <div class="imgs-profile">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="mb20"></div>
                                                    <a href="{{ asset('assets/images/authors/avatar.jpg') }}" data-rel="prettyPhoto" class="img-single">
                                                        <img src="{{ asset('assets/images/authors/avatar.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                                </div>
                                            </div>
                                            <!-- media -->
