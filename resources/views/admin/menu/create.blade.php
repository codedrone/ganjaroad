        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    {!! Form::open(array('url' => URL::to('admin/menu/create'), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
                    <div class="form-group {{ $errors->first('title', 'has-error') }}">
                        <label for="title" class="col-sm-2 control-label">
                            @lang('menu/form.title')
                        </label>
                        <div class="col-sm-5">
                            {!! Form::text('title', null, array('class' => 'form-control', 'placeholder' => trans('menu/form.title'))) !!}
                        </div>
                        <div class="col-sm-4">
					...
					<div class="form-group {{ $errors->first('position', 'has-error') }}">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text('position', null, array('class' => 'form-control input-lg', 'placeholder' => trans('menu/form.position'))) !!}
                        </div>
                        <div class="col-sm-4">
					...
					<div class="form-group {{ $errors->first('parent', 'has-error') }}">
                        ...
                        <div class="col-sm-5">
                            {!! Form::SelectCategories('parent', $menus, null, array('class' => 'form-control select2', 'placeholder'=>trans('menu/form.select-category')), null) !!}
                        </div>
                        <div class="col-sm-4">
