...
@section('title')
    @lang('nearmeitemscategory/title.create') :: @parent
@stop
...
<section class="content-header">
    <h1>
        @lang('nearmeitemscategory/title.create')
    </h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li>@lang('nearmeitemscategory/title.nearmecategories')</li>
        <li class="active">
            @lang('nearmeitemscategory/title.create')
        </li>
    </ol>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    {!! Form::open(array('url' => URL::to('admin/nearmeitemscategory/create'), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
