...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('plans/title.edit')</li>
    </ol>
</section>
<!--section ends-->
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
           ...
           {!! Form::model($plan, array('url' => URL::to('admin/plans/' . $plan->id.'/edit'), 'method' => 'post', 'id' => 'plans_form', 'class' => 'bf', 'files'=> true)) !!}
				<div class="row">
                    <div class="col-sm-8">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="form-group hidden">
								{!! Form::label('published', trans('plans/form.code')) !!}
...
$("document").ready(function() {
	...
	var classifieds = $('#classifieds_categories').jstree({
		'core' : {
			'animation' : 0,
			'check_callback': true,
			'themes' : { 'default' : true },
	...
	var nearme = $('#nearme_categories').jstree({
		'core' : {
			'animation' : 0,
			'check_callback': true,
			'themes' : { 'default' : true },
